...
Node to filter and process LiDAR data from an ouster lidar
...
class LidarOusterProcessingNode(Node):

    def __init__(self):
        super().__init__('lidar_ouster_processing_node')

        self.pcd_cached = None
        self.clock = 0.0
    ...
    def lidarCb(self, msg: PointCloud2):
        ...
        msg_array = self.remove_nearby_points(self.pcd_cached, (-4.0,0.5), (-1.3,1.3))
